...
return {
    ...
    link: function($scope, elem, attrs) {
        ...
        $scope.searchTimerComplete = function(str) {
            // Begin the search
            //console.log("searchTimerComplete :"+$scope.fetchFunction+" str"+str);

            if (str.length >= $scope.minLength) {
                
                
                if ($scope.fetchFunction) {
                    console.log("fetchFunction:"+$scope.fetchFunction);
                    $scope.fetchFunction(str).then(function (matches) {     
                        console.log("on resonse");                                                                    
                        $scope.searching = false;
        ...
        $scope.selectResult = function(result) {
            console.log("on selection "+result, $scope.onSelction)
            if ($scope.matchClass) {
